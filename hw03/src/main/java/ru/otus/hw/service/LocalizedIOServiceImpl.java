...
public class LocalizedIOServiceImpl implements LocalizedIOService {
    ...
    public LocalizedIOServiceImpl(@Qualifier("localizedMessageService") LocalizedMessagesService localizedMessagesService,
                                  @Qualifier("unlocalized") IOService ioService) {
