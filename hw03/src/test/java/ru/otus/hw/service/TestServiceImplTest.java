...
public class TestServiceImplTest {
    ...
    void prepareIoServiceInputMocks() {
        ...
        for (var question : questions) {
            ...
            given(ioService.readIntForRangeWithPromptLocalized(1, answers.size(),
    ...
    void shouldOutputAllQuestionsWithCorrespondingAnswers() {
        ...
        for (int i = 0; i < questions.size(); ++i) {
            ...
            verify(ioService).printFormattedLineLocalized("TestService.question.number", i + 1, question.text());
            ...
            verify(ioService).readIntForRangeWithPromptLocalized(1, answers.size(),
                    "TestService.answer.input.number",
                    "TestService.answer.input.number.error");
        }
